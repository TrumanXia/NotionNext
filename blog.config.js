...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'fc6e2d22c8cc4226a66b70c37490c633',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '阿浪爱分享', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '阿浪与您一起玩弄各种资源', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://alanglovesharing.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '阿浪爱分享, alang, 博客, notion', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'alanglovesharing@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || 'RLK2O4LSWD', // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || null, // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY: process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || '3f9ec7069eaef63db182357b9de3a3e8', // 客户端搜索用的KEY
  ALGOLIA_INDEX: process.env.NEXT_PUBLIC_ALGOLIA_INDEX || 'alanglovesharing', // 在Algolia中创建一个index用作数据库
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.alanglovesharing.top/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
