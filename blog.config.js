...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '整理实用免费的电脑软件，手机app，开源方案。普及计算机使用知识。与科技同行。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '阿浪爱分享', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '整理实用免费的电脑软件，手机app，开源方案。普及计算机使用知识。与科技同行。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://alanglovesharing.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '阿浪, alang, Notion, 博客', // 网站关键词 英文逗号隔开
